...
namespace Campr.Server.Lib.Repositories
{
    public interface IUserPostRepository
    {
        ...
        Task<IList<UserPost>> GetAsync(string ownerId, ITentFeedRequest feedRequest, CancellationToken cancellationToken = new CancellationToken());
        Task<long> CountAsync(string ownerId, ITentFeedRequest feedRequest, CancellationToken cancellationToken = new CancellationToken());
